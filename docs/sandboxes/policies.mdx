...
# Static, optional: portable UI capabilities. Within this explicit section,
# omitted values deny access. Only drivers advertising complete support accept it.
# ui:
